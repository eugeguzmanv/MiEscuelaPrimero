...
const repreRouter = express.Router();
...
repreRouter.post('/registro', async (req, res) => { 
    try{
...
repreRouter.post('/login', async (req, res) => {
    try{
...
repreRouter.put('/actualizar', async (req, res) => {
    try{
...
repreRouter.post('/restablecerContrasena', async (req, res) => { 
    try{
...
repreRouter.get('/Id/:id', async (req, res) => {
    try{
...
repreRouter.get('/Tel/:numero_telefonico', async (req, res) => {
    try{
